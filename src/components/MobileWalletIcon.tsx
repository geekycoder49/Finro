...
interface MobileWalletIconProps {
    size?: number;
    color?: string;
}

export const MobileWalletIcon: React.FC<MobileWalletIconProps> = ({ size = 32, color = '#3B82F6' }) => {
    return (
        <Svg width={size} height={size} viewBox="0 0 88.46 122.88">
            <Path
